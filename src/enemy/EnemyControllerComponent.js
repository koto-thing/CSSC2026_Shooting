...
export class EnemyControllerComponent extends Component {
  ...
  #move(deltaTime) {
    ...
    const pattern = EnemyMovePatterns[this.movePattern] ?? EnemyMovePatterns.straightDown;
  ...
  #shot(_deltaTime) {
    ...
    const pattern = EnemyShotPattern[this.shotPattern] ?? EnemyShotPattern.singleDown;
