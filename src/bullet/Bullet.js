import { CircleColliderComponent, ColliderComponent, EllipseColliderComponent, GameObject } from "../engine/index.js";
    ...
    #configureCollider({ hitShape = "circle", hitRadius = 4, hitWidth, hitHeight } = {}) {
        ...
        if (hitShape === "ellipse") {
            if (!(currentCollider instanceof EllipseColliderComponent)) {
                ...
                this.addComponent(new EllipseColliderComponent({
